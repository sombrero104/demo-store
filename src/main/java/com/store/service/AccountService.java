...
public class AccountService {
    ...
    public void logout(String refreshToken) {
        long deleted = jwtRepository.deleteByRefreshToken(refreshToken);
        if (deleted == 0) {
            log.warn("[logout] refreshToken not found in DB.");
        } else {
