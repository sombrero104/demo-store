...
class AccountControllerTest {
    ...
    void login() throws Exception {
        ...
        assertTrue(jwtRepository.findById(findAccount(userEmail).getId()).isPresent());
    }
    ...
    void refresh() throws Exception {
        ...
        assertEquals(
                ...
                jwtRepository.findById(findAccount(userEmail).getId())
    ...
    void logoutDeletesRefreshToken() throws Exception {
        ...
        assertTrue(jwtRepository.findById(accountId).isPresent());
        ...
        assertFalse(jwtRepository.findById(accountId).isPresent());
    }
