...
class OrderServiceTest {
    ...
    void cancelOrderItems() {
        ...
        ProductOption option = ProductOption.of(productColor, "L", BigDecimal.valueOf(1_000), 1);
        OrderItem item = OrderItem.of(Orders.of(account), option, 1, BigDecimal.valueOf(1_000));
